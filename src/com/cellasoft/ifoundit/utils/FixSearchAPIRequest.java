...
/**
 * Created by netsysco on 12/07/2014.
 */
public class FixSearchAPIRequest {

    public static String defaultApiKey = "samplekey";
     ...
     *
     * @param apiKey          String, a valid API key (use "samplekey" for experimenting).
     ...
     * @param toAge           toAge
     * @param person          A Person object (available at
     ...
     * @param queryParamsMode String, one of "and"/"or" (default "and"). Advanced parameter,
     ...
     * @param exactName       boolean (default False). If set to True the names in the query
     ...
     */
    public FixSearchAPIRequest(String apiKey, String firstName, String middleName,
    ...
    private FixSearchAPIRequest(Builder builder) {
     ...
     * records per query.
     *
     * @param recordsFilter a class instance that holds the params: domain, category,
     ...
     *
     * @param priorityRule a class instance that holds the params: domain, category,
     ...
     *
     * @return encoded url
     * @throws IOException        thrown if Person object serialization fails
     * @throws URISyntaxException thrown if URL build fails
     */
    public String url() throws IOException, URISyntaxException {
        Uri.Builder ub;
        ub = Uri.parse(BASE_URL).buildUpon();
        ub.appendQueryParameter("type", "1");
        ub.appendQueryParameter("key", apiKey == null ? defaultApiKey : apiKey);
        ub.appendQueryParameter("person", Utils.toJson(person));
        ub.appendQueryParameter("query_params_mode", queryParamsMode);
        ub.appendQueryParameter("exact_name", String.valueOf(exactName));
        ub.appendQueryParameter("prioritize_records_by", Utils.join(",", prioritizeRecordsBy));
        ub.appendQueryParameter("filter_records_by", Utils.join(",", filterRecordsBy));
        return ub.toString();
    }
     ...
     * sendAsync method.
     *
     * @param strictValidation `strictValidation` is a bool argument that's passed to the
    ...
    public static class Builder {
        ...
        public FixSearchAPIRequest build() {
            return new FixSearchAPIRequest(this);
        }
